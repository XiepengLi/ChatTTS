...
class Chat:
    ...
    def _load(
        ...
        if gpt_config_path:
            ...
            if compile and 'cuda' in str(device) and torch.cuda.get_device_properties(device).major >= 7:
                # _CudaDeviceProperties(name='NVIDIA P106-100', major=6, minor=1, total_memory=6143MB, multi_processor_count=10)
